...
class _JournalScreenState extends State<JournalScreen> {
  late final JournalResearchController _research;

  @override
  void initState() {
    super.initState();
    _research = JournalResearchController();
    _research.loadInitial();
  }
  ...
  bool _hasActiveFilters(JournalResearchController research) {
    return research.fromDate != null ||
        research.toDate != null ||
        research.speciesFilter.isNotEmpty ||
        research.landUseFilter != null ||
        research.healthScoreFilter != null;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final body = ChangeNotifierProvider.value(
      value: _research,
      child: Consumer<JournalResearchController>(
        builder: (context, research, _) {
          final entries = research.filteredReports.take(24).toList();
          final filtersActive = _hasActiveFilters(research);

          return CustomScrollView(
            slivers: [
              SliverPadding(
                padding: EdgeInsets.fromLTRB(24, widget.embedded ? 16 : 8, 24, 0),
                sliver: SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (filtersActive && !research.loading) ...[
                        const SizedBox(height: 8),
                        Text(
                          l10n.journalFilteredCount(research.observationCount),
              ...
              if (research.loading && entries.isEmpty)
                SliverToBoxAdapter(
                  child: Padding(
                  ...
                  child: BentoCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          filtersActive
                              ? l10n.journalFilteredSummaryBody
                              : l10n.journalWeeklyBody,
                        ),
                        const SizedBox(height: 16),
                        Row(
                          children: [
                            _MiniStat(
                              value: '${research.observationCount}',
                              label: l10n.journalObservations,
                            ),
                            const SizedBox(width: 24),
                            _MiniStat(
                              value: '${research.distinctSpeciesCount}',
