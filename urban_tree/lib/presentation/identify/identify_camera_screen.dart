              ...
              children: [
                Container(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(color: Colors.white, fontSize: 11, letterSpacing: 1.2),
                  ),
                ),
                Container(
                      ...
                      for (final corner in [
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border(
                                top: corner == Alignment.topRight || corner == Alignment.topLeft
                                    ? const BorderSide(color: Colors.white, width: 4)
                                    : BorderSide.none,
                                left: corner == Alignment.topLeft || corner == Alignment.bottomLeft
                                    ? const BorderSide(color: Colors.white, width: 4)
                                    : BorderSide.none,
                                right: corner == Alignment.topRight || corner == Alignment.bottomRight
                                    ? const BorderSide(color: Colors.white, width: 4)
                                    : BorderSide.none,
                                bottom: corner == Alignment.bottomLeft || corner == Alignment.bottomRight
                                    ? const BorderSide(color: Colors.white, width: 4)
                                    : BorderSide.none,
                              ),
                            ),
